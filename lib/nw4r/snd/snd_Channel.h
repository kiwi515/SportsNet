...
struct Channel {
    ...
    inline bool IsActive() const { return mActiveFlag; }
    ...
    inline bool IsAutoUpdateSweep() const { return mAutoUpdateSweepFlag; }

    inline bool IsPause() const { return mPauseFlag; }
