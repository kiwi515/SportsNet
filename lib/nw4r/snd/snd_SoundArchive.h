...
struct SoundArchive {
    ...
    virtual ut::FileStream* OpenStream(void*, int, u32,
                                       u32) const = 0; // at 0x18
    virtual ut::FileStream* OpenExtStream(void*, int, const char*, u32,
                                          u32) const = 0; // at 0x1c
    ...
    ut::FileStream* OpenExtStreamImpl(void*, int, const char*, u32,
                                      u32) const; // inlined
