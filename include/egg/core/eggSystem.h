...
struct BaseSystem {
    ...
    static inline Heap* getRootHeapMem1() { return mConfigData->mRootHeapMem1; }

    static inline Heap* getRootHeapMem2() { return mConfigData->mRootHeapMem2; }

    static inline Heap* getRootHeapDebug() {
        return mConfigData->mRootHeapDebug;
    }

    static inline Video* getVideo() { return mConfigData->getVideo(); }

    static inline Display* getDisplay() { return mConfigData->getDisplay(); }
