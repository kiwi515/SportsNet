...
struct InfoChunk {
    Util::DataRef<SoundCommonTable, void, void, void>
        mSoundCommonTable;                                     // at 0x0
    ...
    Util::DataRef<SoundArchivePlayerInfo, void, void, void>
        mSoundArchivePlayerInfo; // at 0x28
};
}; // namespace SoundArchiveFile
...
struct SoundArchiveFileReader {
    ...
    const SoundArchiveFile::SoundCommonInfo*
        impl_GetSoundInfo(u32) const; // inlined
    ...
    const SoundArchiveFile::PlayerInfo*
        impl_GetPlayerInfo(u32) const; // inlined
    ...
    bool
    ReadSoundArchivePlayerInfo(SoundArchive::SoundArchivePlayerInfo*) const;
    ...
    u32 ConvertLabelStringToId(const SoundArchiveFile::StringTree*,
                               const char*) const;

    SoundArchiveFile::SoundInfoOffset impl_GetSoundInfoOffset(u32) const;

    inline u16 GetVersion() const { return mHeader.mHeader.version; }
    ...
    inline u32 GetInfoChunkOffset() const { return mHeader.mInfoChunkOffset; }

    inline u32 GetInfoChunkSize() const { return mHeader.mInfoChunkSize; }
};
} // namespace detail
} // namespace snd
} // namespace nw4r
