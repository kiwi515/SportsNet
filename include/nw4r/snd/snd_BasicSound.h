...
struct BasicSound : ut::Polymorphic {
    struct AmbientParamUpdateCallback {
        virtual void detail_Update(SoundParam*, u32, BasicSound*, const void*,
                                   u32) = 0;
    };
    ...
    inline virtual const ut::detail::RuntimeTypeInfo*
    ...
    UNKTYPE SetAmbientParamCallback(AmbientParamUpdateCallback*,
                                    AmbientArgUpdateCallback*,
                                    AmbientArgAllocaterCallback*, void*);
