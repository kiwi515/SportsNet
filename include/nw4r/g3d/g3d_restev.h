...
struct ResTev {
    ...
    bool GXGetTevSwapModeTable(GXTevSwapSel, GXTevColorChan*, GXTevColorChan*,
                               GXTevColorChan*, GXTevColorChan*) const;
    void GXSetTevSwapModeTable(GXTevSwapSel, GXTevColorChan, GXTevColorChan,
                               GXTevColorChan, GXTevColorChan);

    bool GXGetTevOrder(GXTevStageID, GXTexCoordID*, GXTexMapID*,
                       GXChannelID*) const;

    void GXSetTevColorIn(GXTevStageID, GXTevColorArg, GXTevColorArg,
                         GXTevColorArg, GXTevColorArg);
